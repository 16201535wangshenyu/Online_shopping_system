...
import com.example.mallmaster.entity.Product;
import com.example.mallmaster.entity.pojo.ResultBean;
import com.example.mallmaster.service.ClassificationService;
import com.example.mallmaster.service.ProductService;
import com.example.mallmaster.utils.FileUtil;
...
public class AdminProductController {
    ...
    public void add(MultipartFile image,
        ...
        if (id <= 0) {
            ...
            request.getRequestDispatcher("admin/product/toAdd.html").forward(request, response);
        } else {
            request.getRequestDispatcher("admin/product/toEdit.html?id=" + id).forward(request, response);
        }
    }
    ...
    public void update(int id,
        ...
        response.sendRedirect("admin/product/toList.html");
    }
